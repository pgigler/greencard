...
const Footer = () => {
	const data = useStaticQuery(graphql`
		query FooterQuery {
			allFile(filter: { relativePath: { in: ["map.png"] } }) {
				edges {
					node {
						relativePath
						childImageSharp {
	...
	const fluidMap = getFluid(data.allFile.edges, "map.png");
							...
							<div className="hover:text-brand-yellow">
								...
								>
									<div itemScope itemType="http://schema.org/address" className="flex items-center">
										...
										<span itemProp="PostalAddress">
											Gyömrői út 117 (bejárat a Hangár utca felől)
										</span>
									</div>
									<div itemScope itemType="http://schema.org/postalAddress">
										<span>
											<span itemProp="PostalCode">1103</span> Budapest
										</span>
									</div>
								</a>
								<div className="text-white flex my-2 justify-center sm:justify-end">
									<div>
										<a
											target="_blank"
											href="https://www.facebook.com/Z%C3%B6ldk%C3%A1rtya-Bt-104471474543433/"
										>
											<svg
									...
									<div>
										<a target="_blank" href="https://instagram.com/zoldkartyabt">
											<svg
